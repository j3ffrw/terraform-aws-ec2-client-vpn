...
| <a name="input_self_service_saml_metadata_document"></a> [self\_service\_saml\_metadata\_document](#input\_self\_service\_saml\_metadata\_document) | Optional self-service SAML metadata document. Must include this or `self_service_saml_provider_arn` | `string` | `null` | no |
| <a name="input_self_service_saml_provider_arn"></a> [self\_service\_saml\_provider\_arn](#input\_self\_service\_saml\_provider\_arn) | Optional self-service SAML provider ARN. Must include this or `self_service_saml_metadata_document` | `string` | `null` | no |
